import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE','sairamjobsproject.settings')
import django
django.setup()
...
def populate(n):
    ...
    for i in range(n):
        ...
        feligibility = fake.random_element(elements=('B.Tech','M.Tech','MCA','Phd','Mahesh Sir Student','MS'))
        ...
        pune_jobs_reocrds = PuneJobs.objects.get_or_create(
            date = fdate,
            company = fcompany,
            title = ftitle,
            eligibility = feligibility,
        ...
        bng_jobs_reocrds = BngJobs.objects.get_or_create(
            date = fdate,
            company = fcompany,
            title = ftitle,
            eligibility = feligibility,
